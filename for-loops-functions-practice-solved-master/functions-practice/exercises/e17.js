...
const array1 = ['a', 'b', 'c'];
const isAInArray1 = doesArrayInclude(array1, 'a'); // true
const isFInArray1 = doesArrayInclude(array1, 'f'); // false

console.log(isAInArray1); // true
console.log(isFInArray1); // false
